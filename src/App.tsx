    ...
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-1.png" alt="League of Legends"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-2.png" alt="Dota 2"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-3.png" alt="Counter Strike: GO"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-4.png" alt="Apex Legends"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-5.png" alt="Fortnite"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/games/game-6.png" alt="World of Warcraft"/>
          <div
            className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 bottom-0 right-0'
          >
